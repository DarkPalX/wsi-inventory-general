...
class UserController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('theme.pages.custom.accounts.users.create',compact('page', 'sections', 'roles', 'employees'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('theme.pages.custom.accounts.users.edit',compact('page', 'user', 'sections', 'roles', 'employees'));
    }
    ...
    public function update_password(Request $request)
    {
        ...
        if ($is_updated) {
            Auth::logout();
            return redirect()->back()->with('alert', 'success:Well done! You successfully updated your password');
        } else {
    ...
    public function user_update_password(Request $request)
    {
        ...
        if ($is_updated) {
            return redirect()->back()->with('alert', 'success:Well done! You successfully updated a password');
        } else {
            return redirect()->back()->with('alert', 'danger:Failed changing password');
        }
    }
