...
class Item extends Model
{
    ...
    {
        return $this->belongsTo(ItemUnit::class)->withTrashed()->withDefault();
    }
    ...
    public static function generateQrCode($barcode, $size) {
    ...
    public function getMACAttribute($date = null) {
        ...
        $qry = \DB::Select("select x.* from
            ...
            idd.item_id, idd.quantity as qty, '0' as cost, 'out' as tayp
            ...
            rd.item_id, rd.quantity as qty, rd.cost as cost,  'in' as tayp
