...
class ReceivingHeader extends Model
{
    ...
    protected $fillable = ['ref_no', 'si_number', 'section_id', 'supplier_id', 'date_received', 'attachments', 'remarks','status', 'created_by', 'updated_by', 'posted_at', 'posted_by', 'cancelled_at', 'cancelled_by'];
