...
<head>
    ...
    <title>Admin Panel | {{ App\Helpers\Setting::info()->company_name }}</title>

    <!-- Favicon -->
	<link rel="icon" href="{{ App\Helpers\Setting::getFaviconLogo() }}" type="image/x-icon">
    ...
    <style>
        ...
        .signin-hero {
            height: 100vh;
            background: #ebf7ff url('{{ App\Helpers\Setting::get_company_logo_storage_path() }}') center center no-repeat;
            background-size: 30%;
        }
    </style>
</head>
            ...
            <div class="col-lg-6">
                <div class="sign-wrapper">
                    <div class="wd-100p">
                        ...
                        <p class="tx-color-03 tx-14 mg-b-40">Welcome to {{ App\Helpers\Setting::info()->website_name }} Admin Portal. Please sign in to continue.</p>
