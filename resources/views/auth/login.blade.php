...
@section('content')
    ...
    <div id="cover-banner" @if($errors->first('email')) hidden @endif>
        ...
        <h2 class="text-uppercase text-light" style="font-size: 35px;">General Inventory System</h2>

        {{-- <h2 class="text-white">General Inventory System</h2> --}}
                    ...
                    <div id="login-section" class="card mx-auto rounded-0 border-0 rounded rounded-5 mt-5 {{ !$errors->first('email') ? 'hidden-login' : '' }}" style="max-width: 500px; background-color: rgba(255,255,255,0.75);">
                        ...
                        <div class="card-body" style="padding: 40px;">
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <button id="loginBtn" type="submit" class="btn btn-md text-white" style="background-color:#fe6400;" {{ request('guest_email') ? 'click' : '' }}>Log In</button>
