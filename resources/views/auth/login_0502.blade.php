...
@section('pagecss')
    <style>
        ...
        #cover-banner::before {
            ...
            width: 100%;
            height: 100%;
            background-color: rgba(79, 68, 68, 0.7); /* Blue color with 50% opacity */
            ...
            <div class="vertical-middle">
                <div class="container-fluid py-5 mx-auto">
                    <div class="text-center">
                        <a href="#"><img src="{{ Setting::get_company_logo_storage_path() }}" alt="DFA Logo" style="max-width: 170px; margin: 20px 0;"></a>
                    </div>
                    ...
                    <div id="login-section" class="card mx-auto rounded-0 border-0 rounded rounded-5" style="max-width: 400px; background-color: rgba(255,255,255,0.93);">
                        <div class="card-body" style="padding: 40px;">
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <button type="submit" class="btn btn-primary btn-sm tx-white">Log In</button>
                                {{-- <a href="{{route('password.request')}}" class="btn btn-info text-white btn-sm">Forgot Password</a> --}}
                            </form>
