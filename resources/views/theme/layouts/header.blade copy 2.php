	...
	<div id="header-wrap" style="background-color:#0047ab;">
		<div class="container">
			<div class="header-row">
				...
				<div id="logo">
					<a href="{{ route('home') }}">
						<img class="logo-default p-2" srcset="{{ asset('theme/images/company-logo.png') }}" src="{{ asset('theme/images/company-logo.png') }}" alt="Logo">
						<img class="logo-dark p-2" srcset="{{ asset('theme/images/company-logo.png') }}" src="{{ asset('theme/images/company-logo.png') }}" alt="Logo">
					</a>
				</div><!-- #logo end -->
