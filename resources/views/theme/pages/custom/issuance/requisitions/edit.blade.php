                        ...
                        <div class="card-body">
							...
							<form method="post" action="{{ route('issuance.requisitions.update', $requisition->id) }}" enctype="multipart/form-data" onsubmit="return checkSelectedItems();">
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<input type="text" class="form-control" id="responsibility_center_code" name="responsibility_center_code" value="{{ $requisition->responsibility_center_code }}" />
									</div>
								</div>
								<div class="form-group row">
											...
											<tbody>
												@foreach($requisition_details as $requisition_detail)
													<tr>
														...
														<td>
															<input name="quantity[]" 
																type="number" step="1" value="{{ $requisition_detail->quantity }}" min="1" max="{{ $requisition_detail->item->inventory }}" onclick="this.select()"
																oninput="
