                    ...
                    <tbody style="font-size:12px !important;">
                        @forelse ($requisitions as $requisition)
                            <tr id="row{{$requisition->id}}">                                
                                ...
                                <td valign="middle">{{ (new DateTime($requisition->date_needed))->format('M d, Y') }}</td>
                                <td valign="middle">
                                    <strong>{{ User::getSection($requisition->requested_by) }} | {{ User::getName($requisition->requested_by) }}</strong><br>
