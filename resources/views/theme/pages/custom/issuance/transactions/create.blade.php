                ...
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
							...
							<form id="issuance_form" method="post" action="{{ route('issuance.transactions.store') }}" enctype="multipart/form-data">
                                @csrf
												...
												@foreach($requisition_details as $requisition_detail)
    												@if($requisition_detail->item->type->id == 1)
														...
														<tr>
															...
															<td>
																<input name="quantity[]" 
																	type="number" step="1" value="0" min="0" max="{{ $requisition_detail->quantity }}" onclick="this.select()"
											...
											<tbody>
												...
												@foreach($requisition_details as $index => $requisition_detail)
													...
													@if($requisition_detail->item->type->id == 2)
														...
														<tr>
															<td colspan="100%">
																<div class="d-none mt-2" id="assign_accountable_div_{{ $index }}">
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<input type="date" class="form-control" id="date_released" name="date_released" value="<?= date('Y-m-d'); ?>" min="{{ date('Y-m-d') }}" onkeypress="if(event.key === 'Enter') { event.preventDefault(); }" required>
									</div>
								</div>
								<div class="form-group row">
								...
								<div class="form-group row" hidden>
									<div class="col-sm-10">
										...
										<input type="text" class="form-control" id="issuance_id" name="issuance_id" value="0" required>
									</div>
								</div>
