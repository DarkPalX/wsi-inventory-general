                ...
                <table width="100%" style="margin-bottom: 0px;">
                    ...
                    <tr>
                        ...
                        @if(RolePermission::has_permission(3,auth()->user()->role_id,1))
                            <td align="right"><a href="{{ route('issuance.requisitions.index') }}" class="btn text-white" style="font-size:14px; background-color: #0d6efd;">Go to Issuance Requests</a></td>
                       @endif
                    </tr>
                    ...
                    <tbody style="font-size:12px !important;">
                        @forelse ($transactions as $transaction)
                            ...
                            <tr id="row{{$transaction->id}}">                                
                                ...
                                <td valign="middle">
                                    @php 
                                        $requisition = App\Models\Custom\RequisitionHeader::where('ref_no', $transaction->ris_no)->first();
                                    @endphp
                                    <a href="{{ route('issuance.requisitions.show-issuance',  $requisition->id) }}" class="btn btn-light text-primary" title="View Transaction"><i class="bi-eye"></i></a>
