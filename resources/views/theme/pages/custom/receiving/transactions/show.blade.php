                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($receiving_details as $receiving_detail)
                                            ...
                                            @php($receiving_net_total = $receiving_net_total  + ($receiving_detail->cost * $receiving_detail->quantity) ?? 0)
                                            ...
                                            {{-- <tr>
                                                ...
                                                <td class="text-end">{{ number_format($receiving_detail->item->cost ?? 0, 2) }}</td>
                                            </tr> --}}
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">{{ number_format($receiving_detail->cost, 2) }}</td>
                                                <td class="text-end">{{ $receiving_detail->quantity }}</td>
                                                <td class="text-end">{{ number_format($receiving_detail->cost * $receiving_detail->quantity, 2) }}</td>
                                            </tr>
                                        @endforeach
                                        <tr>
