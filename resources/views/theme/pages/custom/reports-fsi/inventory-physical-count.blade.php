            ...
            <div class="col-md-10">
                ...
                <div class=	"print-area col-12">
                    <table class="col-12 border border-1 border-dark thick-top-border thick-bottom-border thick-right-border thick-left-border">
                        ...
                        {{-- HEADINGS --}}
                        <tr>
                            <td colspan="100%" class="text-end"><i>Appendix 66 &nbsp;</i></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="border border-0 text-center" colspan="10"><small style="font-size:12px;">(Type of Inventory Item)</small></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="border border-0" colspan="10"><strong>For which <u>{{ Auth::user()->name }}</u>, <u>{{ Auth::user()->section->name }}</u>, <u>{{ Setting::info()->company_name }}</u> is accountable, having assumed such accoutability on <u>{{ Carbon\Carbon::now()->format('M d, Y') }}</u>.</strong></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="border border-1 border-dark" style="text-align: center;" width="10%" rowspan="2"><strong>Stock Number</strong></td>
                            <td class="border border-1 border-dark" style="text-align: center;" width="10%" rowspan="2"><strong>Unit of Measurement</strong></td>
                            <td class="border border-1 border-dark" style="text-align: center;" width="10%" rowspan="2"><strong>Unit Value</strong></td>
                            <td class="border border-1 border-dark" style="text-align: center;" width="10%"><strong>Balance Per Card</strong></td>
                            <td class="border border-1 border-dark" style="text-align: center;" width="10%"><strong>On Hand Per Card</strong></td>
